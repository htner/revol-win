...
#ifdef UNDER_CE
  typedef float REAL; 
  typedef float REAL_X; 
#else
  typedef double REAL; 
  typedef float REAL_X; 
#endif

typedef REAL_X POS;         // position
typedef REAL_X DIM;         // dimension
typedef REAL_X ANGLE;       // angle (radians)
