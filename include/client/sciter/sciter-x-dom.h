 ...
 * \param[in] he \b #HELEMENT 
 * \param[in] doRelayout \b BOOL, TRUE indicates that intrinsic dimansions of the element have changed - need relayout.
 * \return \b #EXTERN_C SCDOM_RESULT SCAPI
 **/
EXTERN_C SCDOM_RESULT SCAPI SciterUpdateElement(HELEMENT he, BOOL doRelayout);
