...
inline void CMarkup::operator=( const CMarkup& markup )
{
...
inline bool CMarkup::SetDoc( MCD_PCSZ szDoc )
{
	// Set document text
	if ( szDoc )
		m_strDoc = szDoc;
...
inline bool CMarkup::SetDoc( const MCD_STR& strDoc )
{
	m_strDoc = strDoc;
	MCD_STRCLEAR(m_strError);
	return x_ParseDoc();
...
inline bool CMarkup::IsWellFormed()
{
	if ( m_aPos.GetSize()
...
inline bool CMarkup::Load( MCD_CSTR szFileName )
{
...
inline bool CMarkup::ReadTextFile( MCD_CSTR szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnFlags )
{
...
inline bool CMarkup::Save( MCD_CSTR szFileName )
{
	return WriteTextFile( szFileName, m_strDoc, &m_strError, &m_nFlags );
}

inline bool CMarkup::WriteTextFile( MCD_CSTR szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnFlags )
{
...
inline bool CMarkup::FindElem( MCD_CSTR szName )
{
...
inline bool CMarkup::FindChildElem( MCD_CSTR szName )
{
...
inline MCD_STR CMarkup::EscapeText( MCD_CSTR szText, int nFlags )
{
...
inline MCD_STR CMarkup::UnescapeText( MCD_CSTR szText, int nTextLength /*=-1*/ )
{
...
inline int CMarkup::UTF16To8( char* pszUTF8, const wchar_t* pwszUTF16, int nUTF8Count )
{
...
inline int CMarkup::DecodeCharUTF8( const char*& pszUTF8 )
{
...
inline void CMarkup::EncodeCharUTF16( int nUChar, wchar_t* pwszUTF16, int& nWideLen )
{
...
inline int CMarkup::UTF8To16( wchar_t* pwszUTF16, const char* pszUTF8, int nUTF8Count )
{
...
inline int CMarkup::DecodeCharUTF16( const wchar_t*& pwszUTF16 )
{
...
inline void CMarkup::EncodeCharUTF8( int nUChar, char* pszUTF8, int& nUTF8Len )
{
...
#if ! defined( UNICODE )
inline MCD_STR CMarkup::UTF8ToA( MCD_CSTR pszUTF8, int* pnFailed/*=NULL*/ )
{
...
inline MCD_STR CMarkup::AToUTF8( MCD_CSTR pszANSI )
{
...
inline MCD_STR CMarkup::GetDeclaredEncoding( MCD_CSTR szDoc )
{
...
inline int CMarkup::FindNode( int nType )
{
...
inline bool CMarkup::RemoveNode()
{
...
inline MCD_STR CMarkup::GetTagName() const
{
...
inline MCD_STR CMarkup::GetAttribName( int n ) const
{
...
inline bool CMarkup::SavePos( MCD_CSTR szPosName )
{
...
inline bool CMarkup::RestorePos( MCD_CSTR szPosName )
{
...
inline bool CMarkup::RemoveElem()
{
...
inline bool CMarkup::RemoveChildElem()
{
...
inline MCD_STR CMarkup::x_GetLastError()
{
	MCD_STR strError;
#ifdef MCD_STRERROR
...
inline bool CMarkup::x_AllocPosArray( int nNewSize /*=0*/ )
{
...
inline bool CMarkup::x_ParseDoc()
{
...
inline int CMarkup::x_ParseElem( int iPosParent, TokenPos& token )
{
...
inline bool CMarkup::x_FindAny( MCD_PCSZ szDoc, int& nChar )
{
...
inline bool CMarkup::x_FindName( CMarkup::TokenPos& token )
{
...
inline MCD_STR CMarkup::x_GetToken( const CMarkup::TokenPos& token )
{
...
inline int CMarkup::x_FindElem( int iPosParent, int iPos, MCD_PCSZ szPath ) const
{
...
inline int CMarkup::x_ParseNode( CMarkup::TokenPos& token, CMarkup::NodePos& node )
{
...
inline MCD_STR CMarkup::x_GetPath( int iPos ) const
{
	MCD_STR strPath;
	while ( iPos )
	{
...
inline MCD_STR CMarkup::x_GetTagName( int iPos ) const
{
...
inline bool CMarkup::x_FindAttrib( CMarkup::TokenPos& token, MCD_PCSZ szAttrib, int n/*=0*/ )
{
...
inline MCD_STR CMarkup::x_GetAttrib( int iPos, MCD_PCSZ szAttrib ) const
{
...
inline bool CMarkup::x_SetAttrib( int iPos, MCD_PCSZ szAttrib, int nValue )
{
...
inline bool CMarkup::x_SetAttrib( int iPos, MCD_PCSZ szAttrib, MCD_PCSZ szValue )
{
...
inline bool CMarkup::x_CreateNode( MCD_STR& strNode, int nNodeType, MCD_PCSZ szText )
{
...
inline MCD_STR CMarkup::x_EncodeCDATASection( MCD_PCSZ szData )
{
...
inline bool CMarkup::x_SetData( int iPos, int nValue )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( szVal, _T("%d"), nValue );
...
inline bool CMarkup::x_SetData( int iPos, MCD_PCSZ szData, int nFlags )
{
...
inline MCD_STR CMarkup::x_GetData( int iPos ) const
{
	if ( iPos == m_iPos && m_nNodeLength )
	{
...
inline MCD_STR CMarkup::x_GetElemContent( int iPos ) const
{
...
inline bool CMarkup::x_SetElemContent( MCD_PCSZ szContent )
{
...
inline void CMarkup::x_DocChange( int nLeft, int nReplace, const MCD_STR& strInsert )
{
...
inline void CMarkup::x_Adjust( int iPos, int nShift, bool bAfterPos /*=false*/ )
{
...
inline int CMarkup::x_InsertNew( int iPosParent, int& iPosRel, CMarkup::NodePos& node )
{
...
inline bool CMarkup::x_AddElem( MCD_PCSZ szName, int nValue, int nFlags )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( szVal, _T("%d"), nValue );
...
inline bool CMarkup::x_AddElem( MCD_PCSZ szName, MCD_PCSZ szValue, int nFlags )
{
	if ( nFlags & MNF_CHILD )
	{
...
inline MCD_STR CMarkup::x_GetSubDoc( int iPos ) const
{
	if ( iPos )
	{
...
inline bool CMarkup::x_AddSubDoc( MCD_PCSZ szSubDoc, int nFlags )
{
...
inline int CMarkup::x_RemoveElem( int iPos )
{
...
inline void CMarkup::x_LinkElem( int iPosParent, int iPosBefore, int iPos )
{
...
inline int CMarkup::x_UnlinkElem( int iPos )
{
...
inline int CMarkup::x_ReleasePos( int iPos )
{
...
inline int CMarkup::x_ReleaseSubDoc( int iPos )
{
...
inline void CMarkup::x_CheckSavedPos()
{
...
inline void CMarkup::x_AdjustForNode( int iPosParent, int iPos, int nShift )
{
...
inline bool CMarkup::x_AddNode( int nNodeType, MCD_PCSZ szText, int nFlags )
{
...
inline void CMarkup::x_RemoveNode( int iPosParent, int& iPos, int& nNodeType, int& nNodeOffset, int& nNodeLength )
{
