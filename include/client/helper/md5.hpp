...
#define T64 /* 0xeb86d391 */ (T_MASK ^ 0x14792c6e)
  ...
  inline void MD5::process( const unsigned char* data /*[64]*/ )
  {
...
#undef SET
  ...
  inline void MD5::feed( const std::string& data )
  {
    feed( (const unsigned char*)data.c_str(), (int)data.length() );
  }

  inline void MD5::feed( const unsigned char* data, int bytes )
  {
  ...
  inline const std::string MD5::hex()
  {
    if( !m_finished )
      finalize();
  ...
  inline const std::string MD5::binary()
  {
    if( !m_finished )
      finalize();
