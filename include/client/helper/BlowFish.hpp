...
inline CBlowFish::CBlowFish(unsigned char* ucKey, size_t keysize, const SBlock& roChain) : m_oChain0(roChain), m_oChain(roChain)
{
...
inline void CBlowFish::Encrypt(SBlock& block)
{
...
inline void CBlowFish::Decrypt(SBlock& block)
{
	unsigned int uiLeft = block.m_uil;
	unsigned int uiRight = block.m_uir;
	uiLeft ^= m_auiP[17];
...
inline void CBlowFish::Encrypt(unsigned char* buf, size_t n, int iMode)
{
...
//Returns false if n is multiple of 8
inline void CBlowFish::Decrypt(unsigned char* buf, size_t n, int iMode)
{
	//Check the buffer's length - should be > 0 and multiple of 8
	if((n==0)||(n%8!=0))
		throw std::exception("Incorrect buffer length");
...
//Returns false if n is multiple of 8
inline void CBlowFish::Encrypt(const unsigned char* in, unsigned char* out, size_t n, int iMode)
{
	//Check the buffer's length - should be > 0 and multiple of 8
	if((n==0)||(n%8!=0))
		throw std::exception("Incorrect buffer length");
...
//Returns false if n is multiple of 8
inline void CBlowFish::Decrypt(const unsigned char* in, unsigned char* out, size_t n, int iMode)
{
	//Check the buffer's length - should be > 0 and multiple of 8
	if((n==0)||(n%8!=0))
		throw std::exception("Incorrect buffer length");
