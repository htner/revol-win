...
*/
typedef char _check_for_64_bit_pointer_matching_GoInt[sizeof(void*)==64/8 ? 1:2];
...
extern __declspec(dllexport) void get_friend_application_list_as_recipient(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void get_friend_application_list_as_applicant(CB_S_I_S_S cCallback, char* operationID, char* req);
...
extern __declspec(dllexport) void get_friend_application_unhandled_count(CB_S_I_S_S cCallback, char* operationID, char* req);
...
//
extern __declspec(dllexport) void get_group_application_list_as_recipient(CB_S_I_S_S cCallback, char* operationID, char* req);

// GetGroupApplicationListAsApplicant retrieves the group application list as an applicant
//
extern __declspec(dllexport) void get_group_application_list_as_applicant(CB_S_I_S_S cCallback, char* operationID, char* req);
...
//
extern __declspec(dllexport) void get_group_application_unhandled_count(CB_S_I_S_S cCallback, char* operationID, char* req);
